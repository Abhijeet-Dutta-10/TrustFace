...
const FriendsAmountPage = () => {
  ...
  const senderLabel = sender.name || 'You';
  const receiverLabel = receiver.name || 'Friend';
  const summaryLine = useMemo(() => {
    return `${senderLabel} → ${receiverLabel}`;
  }, [receiverLabel, senderLabel]);

  const receiverInitial = receiverLabel?.trim().charAt(0).toUpperCase() || 'F';
          ...
          <section className="bank-amount-card">
            ...
            <div className="bank-amount-accounts-grid">
              <div className="bank-amount-account-card">
                ...
                <p className="bank-amount-account-value">{senderPhone}</p>
                <p className="bank-amount-account-meta">{senderUpi}</p>
              </div>
              <div className="bank-amount-account-card">
                <p className="bank-amount-label">To</p>
                <p className="bank-amount-account-value">{receiverPhone}</p>
                <p className="bank-amount-account-meta">{receiverUpi}</p>
              </div>
            </div>
...
export default FriendsAmountPage;
