...
import './BankTransferConfirmPage.css';
...
const BankTransferConfirmPage = () => {
  ...
  const senderName = sender.name?.trim() || 'Sender Name';
  const senderAccount = sender.account?.trim() || 'Sender Account';
  const senderIfsc = sender.ifsc?.trim() || 'Sender IFSC';
  const receiverName = receiver.name?.trim() || 'Receiver Name';
  const receiverAccount = receiver.account?.trim() || 'Receiver Account';
  const receiverIfsc = receiver.ifsc?.trim() || 'Receiver IFSC';
        ...
        <div className="user-details-side">
          ...
          <div className="user-details-wrapper">
            <div className="user-details-header compact-header">
              <h2 className="user-details-title">Transfer Details</h2>
              <p className="user-details-subtitle">
                Review the sender, receiver, and amount before confirming the transfer.
              </p>
            </div>
            ...
            <div className="transfer-details-cards">
              <div className="transfer-details-card">
                ...
                <div className="transfer-details-row">
                  ...
                  <strong>{senderAccount}</strong>
                </div>
                <div className="transfer-details-row">
                  <span>IFSC Code</span>
                  <strong>{senderIfsc}</strong>
                </div>
              </div>
              ...
              <div className="transfer-details-card">
                ...
                <div className="transfer-details-row">
                  <span>Account No</span>
                  <strong>{receiverAccount}</strong>
                </div>
                <div className="transfer-details-row">
                  <span>IFSC Code</span>
                  <strong>{receiverIfsc}</strong>
                </div>
              </div>

              <div className="transfer-details-card">
                <div className="transfer-card-title">Transfer</div>
                <div className="transfer-details-row">
                  <span>Amount</span>
        ...
        <div className="camera-side">
          <div className="camera-wrapper">
            <div className="camera-header">
              ...
              <p className="camera-subtitle">Verify your face to authorize the transfer.</p>
            </div>
...
export default BankTransferConfirmPage;
